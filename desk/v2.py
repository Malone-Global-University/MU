"""
MD to HTML Converter - Version 2.0
Date: 2025-08-16
...
def convert_all_markdown_recursive(base_dir="lessons"):
...
def convert_all_markdown_single(base_dir="lessons"):
...
if __name__ == "__main__":
    # Default: recursive conversion of all .md files in "lessons"
    convert_all_markdown_recursive("lessons")

    # Example usage for single-folder conversion:
    # convert_all_markdown_single("lessons/math")
